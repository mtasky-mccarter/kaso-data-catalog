-- Dodávateľský doklad a riadky
-- Grain: One document line
-- Proves: Raw document state and canonical current fulfilment interpretation
-- Does not prove: Physical receipt from final header state
-- Fan-out: Header values repeat across lines.
